...
<html lang="en">
  ...
  <div class="col-md-3">
    ...
    <input type="number" class="form-control" id="validationCustom05" name="zip" required maxleght="5">
    <div class="invalid-feedback">
  ...
  <div class="col-12">
    <div class="form-check">
      <input class="form-check-input" type="checkbox" value="" id="invalidCheck" name="agremen"  required>
